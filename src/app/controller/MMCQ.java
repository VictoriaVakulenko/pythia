...
public class MMCQ {
    ...
    private static double FRACT_BY_POPULATION = 0.85;
    ...
    public static class VBox {
        ...
        public String toString() {
            String text = "r1: " + r1 + "/ r2: " + r2 + "/ g1: " + g1 + "/ g2: " + g2 + "/ b1: " + b1 + "/ b2: " + b2;
            return text;
        }
    ...
    public static class CMap {
        ...
        public int[] nearest(int[] color) {
            ...
            for (int i = 0; i < numVBoxes; i++) {
                ...
                d2 = Math.sqrt(Math.pow(color[0] - vbColor[0], 2) + Math.pow(color[1] - vbColor[1], 2)
